...
<head>
  ...
  <!-- plugins:css -->
  <link rel="stylesheet" href="{{ asset('backend/node_modules/materialdesignicons.min.css') }} ">
  <link rel="stylesheet" href="{{ asset('backend/node_modules/simple-line-icons.css') }}">
  <!-- endinject -->
